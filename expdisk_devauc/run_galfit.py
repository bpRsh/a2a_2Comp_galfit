...
def run_galfit(galaxy, band, outdir, count, centroid_file):
    ...
    Runs galfit on the given input galaxies and creates model
        ...
        galaxy        : path of input galaxy, e.g '/Users/poudel/jedisim/simdatabase/galaxies'
    ...
    """
    # galaxy = '/Users/poudel/jedisim/simdatabase/galaxies_original'
    # galaxy = '/Users/poudel/jedisim/simdatabase/galaxies_exptime'
    # band = f606w or f814w
    ingal = galaxy + '/' + band + '_gal' + str(count) + '.fits'
...
def main():
    ...
    galaxy = '/Users/poudel/jedisim/simdatabase/galaxies_original'
    galfit_outdir_f6 = 'galfit_outputs_f6'
    ...
    for count in range(0, 302):
        run_galfit(galaxy, 'f606w', galfit_outdir_f6, count, centroid_f6)
